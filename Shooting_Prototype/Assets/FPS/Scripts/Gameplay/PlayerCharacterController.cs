...
namespace Unity.FPS.Gameplay
{
    ...
    public class PlayerCharacterController : MonoBehaviour
    {
        ...
        public void buffSpeed(float ratio)
        {
            MaxSpeedOnGround *= 1 + ratio;
            MaxSpeedInAir *= 1 + ratio;
        }
        public void buffJump(float ratio)
        {
            JumpForce *= 1 + ratio;
            MinSpeedForFallDamage *= 1 + ratio;
            MaxSpeedForFallDamage *= 1 + ratio;
        }

        private PlayerTransformEventReturnData GetPlayerTransformData(PlayerTransformEvent evt)
        {
            PlayerTransformEventReturnData playerTransformEventReturnData =
            EventsReturnData.playerTransformReturnData;

            playerTransformEventReturnData.Transform = transform;

            return playerTransformEventReturnData;
        }
        void Awake()
        {
            ...
            ReturnableEventManager.AddListener
            <PlayerTransformEventReturnData, PlayerTransformEvent>
            (GetPlayerTransformData);
        }
