...
namespace Unity.FPS.Gameplay
{
    ...
    public class ChargedWeaponEffectsHandler : MonoBehaviour
    {
        ...
        public GameObject[] ChargingObjects;

        [Tooltip("The spinning frame")]
        public GameObject[] SpinningFrames;
        ...
        void Update()
        {
            ...
            for (int i = 0; i < ChargingObjects.Length; i++)
            {
                GameObject ChargingObject = ChargingObjects[i];

                GameObject SpinningFrame = SpinningFrames[i];
