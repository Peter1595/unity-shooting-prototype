...
namespace Unity.FPS.Gameplay
{
    public class ProjectileChargeParameters : MonoBehaviour
    {
        ...
        public MinMaxFloat ChainningDamage;
        ...
        void OnShoot()
        {
            ...
            if (proj)
            {
                ...
                ProjectileLightiningChain projectileLightiningChain = GetComponent<ProjectileLightiningChain>();

                if (projectileLightiningChain)
                {
                    projectileLightiningChain.damage = ChainningDamage.GetValueFromRatio(m_ProjectileBase.InitialCharge);
                }
            }
        }
    }
